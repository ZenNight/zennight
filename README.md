...
|---|---|---|
| **Sentinel MedCAD Studio** | Biomedical Engineering, CAD & 3D Modeling | A local-first desktop concept for biomedical modeling, CAD workflows, prosthesis prototyping and technical documentation. |
| **Sentinel Copilot** | Local LLMs & RAG | AI assistant concept focused on biomedical engineering support, scientific references, material suggestions and structured project planning. |
| **Biomedical RAG Research** | AI + Scientific Sources | Research around using open scientific sources for anatomy, biomechanics, prosthetics, additive manufacturing, medical materials and engineering documentation. |
| **Arduino & Robotics Projects** | Embedded Systems | Academic projects involving sensors, servos, automation logic, ultrasonic modules and practical electronics. |
| **Programming & Engineering Exercises** | Computer Engineering | Projects and exercises using Python, C, C++, C#, JavaScript/TypeScript and mathematical problem solving. |
| **Game Development Experiments** | Game Design & Engines | Experiments with 3D games, gameplay systems, optimization and interactive environments using multiple engines. |
| **Apex Optimizer** | Windows Optimization | Batchfile-based project focused on Windows tweaks and performance improvements for Apex Legends. |
